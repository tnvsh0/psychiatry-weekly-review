...
**כתב עת:** 📄 Eur J Pediatr | **סוג מחקר:** מאמר מחקרי | **מחברים:** Kara-Aksay A et al. | **תאריך:** 2026 Jun 19
...
CONCLUSIONS: Parental concerns about vaccines persist after a diagnosis of neurodevelopmental disorders. Tailored education and communication strategies are essential to support informed vaccine decision-making in these families and to prevent refusal for both diagnosed children and their sibli…

🔗 [קישור למאמר ב-PubMed](https://pubmed.ncbi.nlm.nih.gov/42319500/)

---

### Nanotechnology-Driven Drug-Delivery Systems: Mechanistic Insights for Pediatric Autism Treatment in 2026
**כתב עת:** 📄 Int J Nanomedicine | **סוג מחקר:** מאמר סקירה | **מחברים:** Atashgahi M et al. | **תאריך:** 2026

<?xml version="1.0"  ?><!DOCTYPE pmc-articleset PUBLIC "-//NLM//DTD ARTICLE SET 2.0//EN" "https://dtd.nlm.nih.gov/ncbi/pmc/articleset/nlm-articleset-2.0.dtd"><pmc-articleset><article xml:lang="en" article-type="review-article" dtd-version="1.4"><processing-meta base-tagset="archiving" mathml-version="3.0" table-model="xhtml" tagset-family="jats"><restricted-by>pmc</restricted-by></processing-meta><front><journal-meta><journal-id journal-id-type="nlm-ta">Int J Nanomedicine</journal-id><journal-id journal-id-type="iso-abbrev">Int J Nanomedicine</journal-id><journal-id journal-id-type="pmc-domain-id">616</journal-id><journal-id journal-id-type="pmc-domain">intjnano</journal-id><journal-id journal-id-type="publisher-id">ijn</journal-id><journal-title-group><journal-title>International Journal of Nanomedicine</journal-title></journal-title-group><issn pub-type="ppub">1176-9114</issn><issn pub-type="epub">1178-2013</issn><publisher><publisher-name>Dove Press</publisher-name></publisher></journal-meta><article-meta><article-id pub-id-type="pmcid">PMC13264409</article-id><article-id pub-id-type="pmcid-ver">PMC13264409.1</article-id><article-id pub-id-type="pmcaid">13264409</article-id><article-id pub-id-type="pmcaiid">13264409</article-id><article-id pub-id-type="pmid">42292036</article-id><article-id pub-id-type="doi">10.2147/IJN.S599496</article-id><article-id pub-id-type="publisher-id">599496</article-id><article-version article-version-type="pmc-version">1</article-version><article-categories><subj-group subj-group-type="heading"><subject>Review</subject></subj-group></article-categories><title-group><article-title>Nanotechnology-Driven Drug-Delivery Systems: Mechanistic Insights for Pediatric Autism Treatment in 2026</article-title><alt-title alt-title-type="running-authors">Atashgahi et al</alt-title><alt-title alt-title-type="running-title">Atashgahi et al</alt-title></title-group><contrib-group><contrib contrib-type="author"><name name-style="western"><surname>Atash…

🔗 [קישור למאמר ב-PubMed](https://pubmed.ncbi.nlm.nih.gov/42292036/)
...
**כתב עת:** 📄 Hum Mutat | **סוג מחקר:** מאמר מחקרי | **מחברים:** Mutlu MB et al. | **תאריך:** 2026

<?xml version="1.0"  ?><!DOCTYPE pmc-articleset PUBLIC "-//NLM//DTD ARTICLE SET 2.0//EN" "https://dtd.nlm.nih.gov/ncbi/pmc/articleset/nlm-articleset-2.0.dtd"><pmc-articleset><article id="humu3130383" xml:lang="en" article-type="research-article" dtd-version="1.4"><processing-meta base-tagset="archiving" mathml-version="3.0" table-model="xhtml" tagset-family="jats"><restricted-by>pmc</restricted-by></processing-meta><front><journal-meta><journal-id journal-id-type="nlm-ta">Hum Mutat</journal-id><journal-id journal-id-type="iso-abbrev">Hum Mutat</journal-id><journal-id journal-id-type="pmc-domain-id">4659</journal-id><journal-id journal-id-type="pmc-domain">humu</journal-id><journal-id journal-id-type="publisher-id">HUMU</journal-id><journal-title-group><journal-title>Human Mutation</journal-title></journal-title-group><issn pub-type="ppub">1059-7794</issn><issn pub-type="epub">1098-1004</issn><publisher><publisher-name>Wiley</publisher-name></publisher></journal-meta><article-meta><article-id pub-id-type="pmcid">PMC13255017</article-id><article-id pub-id-type="pmcid-ver">PMC13255017.1</article-id><article-id pub-id-type="pmcaid">13255017</article-id><article-id pub-id-type="pmcaiid">13255017</article-id><article-id pub-id-type="pmid">42293335</article-id><article-id pub-id-type="doi">10.1155/humu/3130383</article-id><article-id pub-id-type="publisher-id">HUMU3130383</article-id><article-version article-version-type="pmc-version">1</article-version><article-categories><subj-group subj-group-type="overline"><subject>Research Article</subject></subj-group><subj-group subj-group-type="heading"><subject>Article</subject></subj-group></article-categories><title-group><article-title>Structural Variant and Repeat Expansion Findings Identified by Optical Genome Mapping in Complex Autism Spectrum Disorder With Concomitant Neurodevelopmental Disorders</article-title></title-group><contrib-group><contrib id="cr-0001" contrib-type="author" corresp="yes"><name name-style="western"…

🔗 [קישור למאמר ב-PubMed](https://pubmed.ncbi.nlm.nih.gov/42293335/)

---

### Sleep disturbances in Attention-Deficit/Hyperactivity Disorder: State of the art and management
**כתב עת:** 📄 Encephale | **סוג מחקר:** מאמר סקירה | **מחברים:** Bioulac S, Claret-Tournier A | **תאריך:** 2026 Jun
...
🔗 [קישור למאמר ב-PubMed](https://pubmed.ncbi.nlm.nih.gov/42297542/)
...
BACKGROUND: Attention-Deficit/Hyperactivity Disorder (ADHD) is a neurodevelopmental disorder that can persist into adulthood and impair occupational functioning. Increasing evidence suggests that adults with ADHD are at elevated risk for workplace accidents due to core symptoms such as inattention, impulsivity, and hyperactivity.

OBJECTIVE: This study systematically reviews the literature to examine the association between adult ADHD and occupational injuries, focusing on risk patterns, contributing mechanisms, and potential workplace accommodations.

METHODS: A systematic literature review was conducted across PubMed, Scopus, Web of Science, ScienceDirect, and Google Scholar. A total of 29 peer-reviewed articles were included based on predefined inclusion and exclusion criteria. Quantitative and qualitative data were analyzed regarding injury risks, industry-specific outcomes, and intervention strategies.

RESULTS: Adults with ADHD were found to have 1.8 to 2.3 times greater risk of occupational injuries compared to neurotypical peers. High-risk industries, including manufacturing and construction, showed the most significant associations. Contributing factors included noncompliance with safety protocols, impulsive behavior, and distraction. Effective interventions include medication, job reassignment, structured feedback, and environmental modifications.
...
- **Eur J Neurosci** — Brittenham C et al. — *Multisensory Attenuation of the Pupil Light Response in Autistic and Non-Autistic Children*
- **Biometrics** — Ran J et al. — *Nonparametric motion control in functional connectivity studies in children with autism spectrum disorder*
- **Fam Med Community Health** — Tsen ASF et al. — *Comparative screening accuracy of the Modified Checklist for Autism in Toddlers, Revised with Follow-Up (M-Chat-R/F) for early autism spectrum disorder: a systematic review*
- **Nutrients** — Zhang S et al. — *Development of a Metagenomics-Guided Personalized Synbiotic Protocol for Children with Autism Spectrum Disorder: An Exploratory Case Series*
- **Psychopharmacol Bull** — Naguy A et al. — *Cariprazine for Autism-A Case Report*
