...
JUDGE_INSTRUCTIONS = (
    ...
    '      "severity": "high"  (a listener acting on it would be misled: a wrong '
    'or invented number, dose or effect size, a reversed or overstated finding, '
    'a study or journal not in the source, or a conclusion the source '
    'contradicts) or '
    '"low" (genuinely wrong but not clinically misleading, e.g. a mispronounced '
    'author name)}.\n'
    '     A SINGLE "high" holds the episode out of the feed and sends it back '
    'for regeneration, so use it for every genuine clinical error and for '
    'nothing else.\n'
    '      "scope": "detail" or "core" — this decides whether the episode can be '
    'rescued with a spoken correction at its start or has to be made again. '
    '"detail" is a discrete point the listener can simply be told the right '
    'version of: a number, a dose, a name, a date, one reversed sentence. '
    '"core" is when the episode\'s MAIN MESSAGE about a paper is wrong — it says '
    'a treatment worked where the paper found it did not, recommends what the '
    'paper warns against, or builds its whole discussion on a finding that is '
    'not there. Ask yourself: after a one-sentence correction at the start, '
    'would the rest of the episode still teach that paper correctly? If yes it '
    'is "detail"; if the twenty minutes that follow keep building the wrong '
    'picture, it is "core".\n'
